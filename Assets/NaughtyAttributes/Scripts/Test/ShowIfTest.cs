namespace NaughtyAttributes.Test
{
    ...
    public class ShowIfTest : MonoBehaviour
    {
        ...
        [ShowIf("enum1", ShowIfEnum.Case0, ShowIfEnum.Case1)] [ReorderableList]
        public int[] showIfEnumAny;
    ...
    public class ShowIfNest1
    {
        ...
        [ShowIf(EConditionOperator.And, "Show1", "Show2")] [AllowNesting]
        // Because it's nested we need to explicitly allow nesting
        public int showIfAll;

        [ShowIf(EConditionOperator.Or, "Show1", "Show2")] [AllowNesting]
        // Because it's nested we need to explicitly allow nesting
        public int showIfAny;
    ...
    public class ShowIfNest2
    {
        ...
        [ShowIf(EConditionOperator.And, "GetShow1", "GetShow2")] [MinMaxSlider(0.0f, 1.0f)]
        ...
        [ShowIf(EConditionOperator.Or, "GetShow1", "GetShow2")] [MinMaxSlider(0.0f, 1.0f)]
        // AllowNesting attribute is not needed, because the field is already marked with a custom naughty property drawer
        public Vector2 showIfAny = new Vector2(0.25f, 0.75f);

        [ShowIf("GetEnum1", ShowIfEnum.Case2)] [MinMaxSlider(0.0f, 1.0f)]
        // AllowNesting attribute is not needed, because the field is already marked with a custom naughty property drawer
        public Vector2 showIfEnum = new Vector2(0.25f, 0.75f);

        [ShowIf("GetEnum2", ShowIfEnumFlag.Flag0)] [MinMaxSlider(0.0f, 1.0f)]
        // AllowNesting attribute is not needed, because the field is already marked with a custom naughty property drawer
        public Vector2 showIfEnumFlag;

        [ShowIf("GetEnum2", ShowIfEnumFlag.Flag0 | ShowIfEnumFlag.Flag1)] [MinMaxSlider(0.0f, 1.0f)]
        // AllowNesting attribute is not needed, because the field is already marked with a custom naughty property drawer
